...
//   //   // if (user) {
//   //   //   console.log("user","h3hhhk")
//   //   //   const userWatchlistRef = firestore.collection("watchlists").doc(user.uid);
//   //   //   userWatchlistRef.update({ movies: arr });
//   //   // }
//    }
...
//     // Update the URL here using Navigate
//     // Check if newData is not empty before updating the URL
//     if (newData.length > 0) {
...
//     // Update the sorted and filtered data
//     setSortedAndFilteredData(newData);
//   };

//   sortAndFilterData();
// }, [selectedOption, All, navigate]);
...
//                   <p>
//                     <Skeleton height={100} width={700} duration={2} />
//                     <Skeleton height={100} width={700} duration={2} />
//                     <Skeleton height={100} width={700} duration={2} />
//                   </p>
//                 </SkeletonTheme>
...
const Watchlist = () => {
  ...
  function hanldeclick(id) {
    ...
    // Update local storage with the updated watchlist data
    updateLocalStorage(arr);
  }

  // Function to update local storage with watchlist data
  function updateLocalStorage(watchlistData) {
    const user = auth.currentUser;
    if (user) {
      const userUID = user.uid;
      const userWatchlistKey = `watchlist_${userUID}`;
      localStorage.setItem(userWatchlistKey, JSON.stringify(watchlistData));
    }
  }
